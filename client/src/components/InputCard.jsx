...
const CLIENT_PRODUCT_ANCHORS = [
  { pattern: /\b(?:infinix\s+note\s*40|infinix\s+note)\b/i, noun: 'Infinix Note 40 Pro' },
  { pattern: /\b(?:infinix\s+gt\s*20|infinix\s+gt)\b/i, noun: 'Infinix GT 20 Pro' },
  { pattern: /\b(?:infinix\s+hot\s*50|infinix\s+hot\s*40|infinix\s+hot)\b/i, noun: 'Infinix Hot 50 Pro' },
  { pattern: /\b(?:poco\s+x6\s*pro|poco\s+x6)\b/i, noun: 'POCO X6 Pro 5G' },
  { pattern: /\b(?:poco\s+m6\s*pro|poco\s+m6)\b/i, noun: 'POCO M6 Pro' },
  { pattern: /\b(?:poco\s+f6|poco\s+f5)\b/i, noun: 'POCO F6 5G' },
  { pattern: /\b(?:redmi\s+note\s*13\s*pro|redmi\s+note\s*14\s*pro)\b/i, noun: 'Redmi Note 13 Pro 5G' },
  { pattern: /\b(?:redmi\s+note\s*13|redmi\s+note\s*14)\b/i, noun: 'Redmi Note 13 5G' },
  { pattern: /\b(?:galaxy\s+a15|samsung\s+a15)\b/i, noun: 'Samsung Galaxy A15 5G' },
  { pattern: /\b(?:galaxy\s+a25|samsung\s+a25)\b/i, noun: 'Samsung Galaxy A25 5G' },
  { pattern: /\b(?:galaxy\s+a35|samsung\s+a35)\b/i, noun: 'Samsung Galaxy A35 5G' },
  { pattern: /\b(?:galaxy\s+a55|samsung\s+a55)\b/i, noun: 'Samsung Galaxy A55 5G' },
  { pattern: /\b(?:iqoo\s+z9x|iqoo\s+z9)\b/i, noun: 'iQOO Z9 5G' },
  { pattern: /\b(?:realme\s+12\s*plus|realme\s+12|realme\s+13)\b/i, noun: 'Realme 12 Plus 5G' },
  { pattern: /\b(?:tecno\s+pova\s*6|tecno\s+pova)\b/i, noun: 'Tecno Pova 6 Pro 5G' },
  { pattern: /\b(?:tecno\s+camon\s*30|tecno\s+camon)\b/i, noun: 'Tecno Camon 30 5G' },
  { pattern: /\b(?:vivo\s+y100|vivo\s+y200)\b/i, noun: 'Vivo Y100 5G' },
  { pattern: /\b(?:vivo\s+v30e|vivo\s+v30)\b/i, noun: 'Vivo V30e 5G' },
  { pattern: /\b(?:oppo\s+reno\s*11f|oppo\s+reno\s*11)\b/i, noun: 'Oppo Reno 11F 5G' },
  { pattern: /\b(?:oppo\s+a79|oppo\s+a78)\b/i, noun: 'Oppo A79 5G' },
  { pattern: /\b(?:smartphone|handphone|android)\b/i, noun: 'Smartphone 2 Jutaan Terbaik' },
];
